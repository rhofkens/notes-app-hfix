  ...
  return (
    <div className={`${mapColorToTailwind(color)} rounded-lg p-6 text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg`}>
      <div className="flex justify-between items-start mb-4">
        ...
        <span 
          className="bg-white text-black text-xs px-2 py-1 rounded-full uppercase transition-all duration-300 ease-in-out hover:bg-opacity-80 hover:scale-105 cursor-pointer"
